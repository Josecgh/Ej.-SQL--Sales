...
4. Para obtener el total de las unidades vendidas en el continente americano: Ver mi archivo "scriptSQL4.sql".
Por cierto, con "%America%" se establece que se refiere tanto a North America como a South America ya que es un filtro todo para lo que tenga la palabra America en el name_continent.
